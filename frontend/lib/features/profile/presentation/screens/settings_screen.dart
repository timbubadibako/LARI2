  ...
  Future<bool> _showConfirmDialog(
    ...
    return await showDialog<bool>(
          ...
          builder: (context) => AlertDialog(
            ...
            content: Text(
              content,
              style: StrideTypography.bodyMD.copyWith(fontSize: 12),
            ),
            actions: [
              TextButton(
              ...
              TextButton(
                ...
                child: const Text(
                  'PROCEED',
                  style: TextStyle(color: StrideColors.error),
                ),
              ),
            ],
          ),
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          left: BorderSide(
            color: value
                ? StrideColors.neonGreen
                : StrideColors.white.withValues(alpha: 0.1),
            width: 4,
          ),
        ),
      ),
      child: Row(
        children: [
          ...
          Switch(
            value: value,
            onChanged: onChanged,
            activeThumbColor: StrideColors.neonGreen,
            activeTrackColor: StrideColors.neonGreen.withValues(alpha: 0.2),
